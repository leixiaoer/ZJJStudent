...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/theme2571.min.css">
    <%--灰色管理员主题 --%>
...
<div class="container">
    <div class="logo">
        <a href="http://localhost:8080/toadd"/>添加图片
    </div>
    <div class="left_open">
            ...
            <c:if test="${sessionScope.adminInfo.power > 2}">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a onclick="xadmin.add_tab('访客登记','${pageContext.request.contextPath}/regist_visitor.jsp')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>访客登记</cite>
                            </a>
                        </li>
